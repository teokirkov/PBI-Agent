...
- **Bidirectional filtering.** Only ever proposed with a stated reason tied
  to a specific cross-filtering requirement in the brief — never as a
  default fix for "the filter isn't reaching the table I expected."
