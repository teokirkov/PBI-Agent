...
7. **Write up** — update `NOTES.md`, open questions, and post a summary
   comment on the issue/PR describing what was built and what's pending.
...
- `best-practices/` — placeholder for the team's Power BI best-practices
  reference (to be filled in from an internal spreadsheet — see that
  skill's README)
